...
export const SITE_NAME = "StatPro India";
export const DEFAULT_OG_IMAGE = `${SITE_URL}/og-default.png`;

const brand = (t) => `${t} | ${SITE_NAME}`;
...
export const SEO_BY_PATH = {
  ...
  "/about": {
    ...
    description:
      "StatPro India is a digital lending advisory and AMFI-registered mutual fund broker. We help businesses and HNIs lower their cost of capital.",
  },
  "/apply": {
  ...
  "/privacy": { title: brand("Privacy Policy"), description: "How StatPro India collects, uses and protects your data.", robots: "index,follow" },
  "/terms": { title: brand("Terms of Service"), description: "Terms and conditions for using StatPro India.", robots: "index,follow" },
  "/grievance": { title: brand("Grievance Redressal"), description: "Grievance redressal mechanism and escalation matrix at StatPro India.", robots: "index,follow" },
  "/disclosures": { title: brand("Disclosures"), description: "Regulatory disclosures by StatPro India.", robots: "index,follow" },
  "/cookies": { title: brand("Cookie Policy"), description: "Cookies used by StatPro India and how to manage them.", robots: "index,follow" },
...
// /landingpage/* (legacy editorial / per-family themed) are excluded —
// paid-traffic destinations, not for organic discovery.
// /lp/* (v2 main-site themed) ARE included — sitemap-eligible.
export const PUBLIC_PATHS = Object.entries(SEO_BY_PATH)
  .filter(([p, v]) => !(v.robots || "").includes("noindex") && !p.startsWith("/landingpage/"))
  .map(([p]) => p);
