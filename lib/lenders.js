// Vite glob import — reads every v2 product JSON at build time.
// Powers the Partners grid, family pages, and any per-partner data display.

const modules = import.meta.glob("../../data/lenders/products/*.v2.json", {
  eager: true,
  import: "default",
});
