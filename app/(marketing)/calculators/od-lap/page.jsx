import OdLapPage from '@/components/pages/OdLapPage'
import { getSeoForPath } from '@/lib/seo-config'
import { breadcrumbForPath } from '@/lib/jsonld'

export function generateMetadata() {
  const seo = getSeoForPath('/calculators/od-lap')
  return {
    title: seo.title,
    description: seo.description,
    keywords: seo.keywords,
    alternates: { canonical: '/calculators/od-lap' },
...
export default function Page() {
  const bc = breadcrumbForPath('/calculators/od-lap')
  return (
    <>
