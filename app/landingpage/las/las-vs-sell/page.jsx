import LasVsSellPage from '@/components/landing/las/LasVsSellPage'
import { getSeoForPath } from '@/lib/seo-config'

export function generateMetadata() {
  const seo = getSeoForPath('/landingpage/las/las-vs-sell')
  return {
    title: seo.title,
    description: seo.description,
    alternates: { canonical: '/landingpage/las/las-vs-sell' },
