import LasMarginCallPage from '@/components/landing/las/LasMarginCallPage'
import { getSeoForPath } from '@/lib/seo-config'

export function generateMetadata() {
  const seo = getSeoForPath('/landingpage/las/margin-call-relief')
  return {
    title: seo.title,
    description: seo.description,
    alternates: { canonical: '/landingpage/las/margin-call-relief' },
