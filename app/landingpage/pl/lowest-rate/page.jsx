import PlLowestRatePage from '@/components/landing/pl/PlLowestRatePage'
import { getSeoForPath } from '@/lib/seo-config'

export function generateMetadata() {
  const seo = getSeoForPath('/landingpage/pl/lowest-rate')
  return {
    title: seo.title,
    description: seo.description,
    alternates: { canonical: '/landingpage/pl/lowest-rate' },
