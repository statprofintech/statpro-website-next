import LrdVsLapPage from '@/components/landing/lrd/LrdVsLapPage'
import { getSeoForPath } from '@/lib/seo-config'

export function generateMetadata() {
  const seo = getSeoForPath('/landingpage/lrd/lrd-vs-lap')
  return {
    title: seo.title,
    description: seo.description,
    alternates: { canonical: '/landingpage/lrd/lrd-vs-lap' },
