import LapSelfEmployedPage from '@/components/landing/lap/v2/LapSelfEmployedPage'
import { getSeoForPath } from '@/lib/seo-config'

export function generateMetadata() {
  const seo = getSeoForPath('/lp/lap/self-employed')
  return {
    title: seo.title,
    description: seo.description,
    alternates: { canonical: '/lp/lap/self-employed' },
