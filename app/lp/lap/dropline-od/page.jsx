import LapDroplineODPage from '@/components/landing/lap/v2/LapDroplineODPage'
import { getSeoForPath } from '@/lib/seo-config'

export function generateMetadata() {
  const seo = getSeoForPath('/lp/lap/dropline-od')
  return {
    title: seo.title,
    description: seo.description,
    alternates: { canonical: '/lp/lap/dropline-od' },
