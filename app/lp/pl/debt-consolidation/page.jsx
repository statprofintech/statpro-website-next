import PlDebtConsolidationPage from '@/components/landing/pl/v2/PlDebtConsolidationPage'
import { getSeoForPath } from '@/lib/seo-config'

export function generateMetadata() {
  const seo = getSeoForPath('/lp/pl/debt-consolidation')
  return {
    title: seo.title,
    description: seo.description,
    alternates: { canonical: '/lp/pl/debt-consolidation' },
