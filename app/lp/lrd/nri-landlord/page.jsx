import LrdNriLandlordPage from '@/components/landing/lrd/v2/LrdNriLandlordPage'
import { getSeoForPath } from '@/lib/seo-config'

export function generateMetadata() {
  const seo = getSeoForPath('/lp/lrd/nri-landlord')
  return {
    title: seo.title,
    description: seo.description,
    alternates: { canonical: '/lp/lrd/nri-landlord' },
