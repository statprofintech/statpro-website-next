import HlFirstTimeBuyerPage from '@/components/landing/hl/v2/HlFirstTimeBuyerPage'
import { getSeoForPath } from '@/lib/seo-config'

export function generateMetadata() {
  const seo = getSeoForPath('/lp/hl/first-time-buyer')
  return {
    title: seo.title,
    description: seo.description,
    alternates: { canonical: '/lp/hl/first-time-buyer' },
